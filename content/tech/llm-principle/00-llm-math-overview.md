...
| 章节 | 标题 | 简介 |
|------|------|------|
| 0 | **[序言：打破黑盒的幻象](./0-preface.md)** - 去神秘化的起点 | 从科幻神话回归矩阵运算，开启数学之旅 |
| 1 | **[第一章：意义的几何学](./1-chapter1-embedding.md)** - 语言的向量化 | Token、Embedding、语义空间与高维几何 |
| 2 | **[第二章：智能的原子](./2-chapter2-attention.md)** - 注意力机制的解构 | Self-Attention、Q/K/V、Softmax 与位置编码 |
| 3 | **[第三章：多维视角的涌现](./3-chapter3-multihead.md)** - 多头注意力与 FFN | Multi-Head、子空间分化、FFN 知识存储与残差连接 |
| 4 | **[第四章：痛苦的学习](./4-chapter4-gradient.md)** - 梯度下降与反向传播 | Loss 地形、链式法则、压缩即智能与优化算法 |
| 5 | **[第五章：时间的箭头](./5-chapter5-decoder.md)** - Decoder-Only 的统治 | 架构之争、因果掩码、KV Cache 与推理优化 |
| 6 | **[终章：毕达哥拉斯的幽灵](./6-chapter6-epilogue.md)** - 数学哲学反思 | 数学的有效性、智能的本质与终极限制 |
